...
const ComingSoon = () => {
  ...
  return (
    ...
    >
      ...
      <div className="page-content mb-7 flex-col z-10 text-center bg-white bg-opacity-60 p-7 w-full lg:w-8/12 rounded-lg shadow-lg">
        ...
        <div className="flex justify-center space-x-4 my-4 ">
          ...
          >
            <FontAwesomeIcon icon={faHandshake} size="2x" /> {/* Remplace par une icône pertinente si nécessaire */}
          </a>
        </div>
      </div>
